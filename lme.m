...
vehicle.beta = 155;                                    % kg/m^2 (ballistic parameter)
...
% FNPEG settings
guid.dpsi_i = 3;        % FNPEG lateral deadband initial width (deg)
...
guid.g_rate = 5;       % guidance every X steps
